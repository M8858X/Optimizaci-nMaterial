...
public class PrimerReto{
	...
	public double NewtonRaphson(double lado, double radio){ //Escenario 3
		...
		double zg1 =  xi;
		double zg2 = (double)Math.round((50 - (xi/2))*1000d)/1000d;
		double a1 = (double)Math.round((lado * lado )*1000d)/1000d;
		double a2 = (double)Math.round((10*xi)*1000d)/1000d;
	...
	public static void main(String[] args){
		...
		test.quadraticFormula(1.5,0.75); // largo (a) = 1.5mts, ancho (b) = 0.75mts
